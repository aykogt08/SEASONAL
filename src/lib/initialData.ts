...
export const INITIAL_FOODS: InitialFoodItem[] = [
  ...
  // ==========================================
  // --- Fruits ---
  { id: "au-f-1", nameEn: "SHINE MUSCAT", nameJa: "シャインマスカット", category: "FRUIT", season: "AUTUMN", iconKey: "grape_green", sortOrder: 1 },
  { id: "au-f-2", nameEn: "KYOHO GRAPE", nameJa: "巨峰・ピオーネ", category: "FRUIT", season: "AUTUMN", iconKey: "grape_purple", sortOrder: 2 },
  { id: "au-f-3", nameEn: "JAPANESE PEAR", nameJa: "和梨（幸水・豊水）", category: "FRUIT", season: "AUTUMN", iconKey: "pear", sortOrder: 3 },
  { id: "au-f-4", nameEn: "LA FRANCE PEAR", nameJa: "洋梨（ラ・フランス）", category: "FRUIT", season: "AUTUMN", iconKey: "pear", sortOrder: 4 },
  { id: "au-f-5", nameEn: "AUTUMN APPLE", nameJa: "りんご（秋映・シナノ）", category: "FRUIT", season: "AUTUMN", iconKey: "apple_red", sortOrder: 5 },
  { id: "au-f-6", nameEn: "PERSIMMON", nameJa: "柿", category: "FRUIT", season: "AUTUMN", iconKey: "persimmon", sortOrder: 6 },
  { id: "au-f-7", nameEn: "FIG", nameJa: "いちじく", category: "FRUIT", season: "AUTUMN", iconKey: "fig", sortOrder: 7 },
  { id: "au-f-8", nameEn: "JAPANESE CHESTNUT", nameJa: "和栗・栗", category: "FRUIT", season: "AUTUMN", iconKey: "chestnut", sortOrder: 8 },
  { id: "au-f-9", nameEn: "POMEGRANATE", nameJa: "ザクロ", category: "FRUIT", season: "AUTUMN", iconKey: "apple_red", sortOrder: 9 },
  { id: "au-f-10", nameEn: "AKEBI", nameJa: "アケビ", category: "FRUIT", season: "AUTUMN", iconKey: "grape_purple", sortOrder: 10 },
  { id: "au-f-11", nameEn: "JUJUBE", nameJa: "なつめ", category: "FRUIT", season: "AUTUMN", iconKey: "citrus_orange", sortOrder: 11 },
  { id: "au-f-12", nameEn: "QUINCE", nameJa: "マルメロ・かりん", category: "FRUIT", season: "AUTUMN", iconKey: "pear", sortOrder: 12 },
  ...
  { id: "au-v-3", nameEn: "NAGANIMO", nameJa: "長芋・山芋", category: "VEGETABLE", season: "AUTUMN", iconKey: "root_vegetable", sortOrder: 22 },
  { id: "au-v-4", nameEn: "LOTUS ROOT", nameJa: "れんこん", category: "VEGETABLE", season: "AUTUMN", iconKey: "lotus_root", sortOrder: 23 },
  { id: "au-v-5", nameEn: "BURDOCK", nameJa: "ごぼう", category: "VEGETABLE", season: "AUTUMN", iconKey: "root_vegetable", sortOrder: 24 },
  ...
  { id: "au-v-8", nameEn: "GINGKO NUT", nameJa: "銀杏", category: "OTHER", season: "AUTUMN", iconKey: "gingko", sortOrder: 27 },
  { id: "au-v-9", nameEn: "MATSUTAKE", nameJa: "松茸", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 28 },
  { id: "au-v-10", nameEn: "SHIITAKE", nameJa: "しいたけ", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 29 },
  { id: "au-v-11", nameEn: "SHIMEJI", nameJa: "しめじ", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 30 },
  { id: "au-v-12", nameEn: "MAITAKE", nameJa: "舞茸・天然舞茸", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 31 },
  { id: "au-v-13", nameEn: "NAMEKO", nameJa: "なめこ・原木なめこ", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 32 },
  { id: "au-v-14", nameEn: "KING OYSTER", nameJa: "エリンギ", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 33 },
  { id: "au-v-15", nameEn: "ENOKI", nameJa: "えのき", category: "OTHER", season: "AUTUMN", iconKey: "mushroom", sortOrder: 34 },
  { id: "au-v-16", nameEn: "EDIBLE FLOWER", nameJa: "食用菊", category: "OTHER", season: "AUTUMN", iconKey: "leafy_green", sortOrder: 35 },

  // --- Seafood ---
  { id: "au-s-1", nameEn: "PACIFIC SAURY", nameJa: "秋刀魚（さんま）", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_silver", sortOrder: 40 },
  { id: "au-s-2", nameEn: "AUTUMN SALMON", nameJa: "秋鮭", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_red", sortOrder: 41 },
  { id: "au-s-3", nameEn: "RETURN BONITO", nameJa: "戻り鰹", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_blue", sortOrder: 42 },
  { id: "au-s-4", nameEn: "MACKEREL", nameJa: "鯖（さば）", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_blue", sortOrder: 43 },
  { id: "au-s-5", nameEn: "SARDINE", nameJa: "鰯（いわし）", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_silver", sortOrder: 44 },
  { id: "au-s-6", nameEn: "ALFONSINO", nameJa: "金目鯛", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_red", sortOrder: 45 },
  { id: "au-s-7", nameEn: "IKURA", nameJa: "生イクラ", category: "SEAFOOD", season: "AUTUMN", iconKey: "salmon_roe", sortOrder: 46 },
  { id: "au-s-8", nameEn: "SUJIKO", nameJa: "筋子", category: "SEAFOOD", season: "AUTUMN", iconKey: "salmon_roe", sortOrder: 47 },
  { id: "au-s-9", nameEn: "FALL SWEETFISH", nameJa: "落ち鮎", category: "SEAFOOD", season: "AUTUMN", iconKey: "fish_blue", sortOrder: 48 },
  { id: "au-s-10", nameEn: "BOTAN SHRIMP", nameJa: "ボタンエビ", category: "SEAFOOD", season: "AUTUMN", iconKey: "shrimp", sortOrder: 49 },
  { id: "au-s-11", nameEn: "SWEET SHRIMP", nameJa: "甘エビ", category: "SEAFOOD", season: "AUTUMN", iconKey: "shrimp", sortOrder: 50 },
  { id: "au-s-12", nameEn: "ZUWAI CRAB", nameJa: "ズワイガニ・香箱蟹", category: "SEAFOOD", season: "AUTUMN", iconKey: "crab", sortOrder: 51 },

  // ==========================================
  // ❄️ WINTER (12〜2月)
  // ==========================================
  // --- Fruits ---
  { id: "wi-f-1", nameEn: "MANDARIN", nameJa: "温州みかん", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 1 },
  { id: "wi-f-2", nameEn: "PONKAN", nameJa: "ぽんかん", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 2 },
  { id: "wi-f-3", nameEn: "IYOKAN", nameJa: "いよかん", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 3 },
  { id: "wi-f-4", nameEn: "HASSAKU", nameJa: "はっさく", category: "FRUIT", season: "WINTER", iconKey: "citrus_yellow", sortOrder: 4 },
  { id: "wi-f-5", nameEn: "KUMQUAT", nameJa: "金柑（きんかん）", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 5 },
  { id: "wi-f-6", nameEn: "WINTER APPLE", nameJa: "りんご（サンふじ）", category: "FRUIT", season: "WINTER", iconKey: "apple_red", sortOrder: 6 },
  { id: "wi-f-7", nameEn: "LE LECTIER", nameJa: "洋梨（ル・レクチェ）", category: "FRUIT", season: "WINTER", iconKey: "pear", sortOrder: 7 },
  { id: "wi-f-8", nameEn: "KIWI", nameJa: "キウイ", category: "FRUIT", season: "WINTER", iconKey: "kiwi", sortOrder: 8 },
  { id: "wi-f-9", nameEn: "WINTER STRAWBERRY", nameJa: "冬いちご", category: "FRUIT", season: "WINTER", iconKey: "strawberry", sortOrder: 9 },
  { id: "wi-f-10", nameEn: "BUNTAN", nameJa: "文旦", category: "FRUIT", season: "WINTER", iconKey: "citrus_yellow", sortOrder: 10 },
  { id: "wi-f-11", nameEn: "SETOKA", nameJa: "せとか", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 11 },
  { id: "wi-f-12", nameEn: "HARUMI", nameJa: "はるみ", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 12 },
  { id: "wi-f-13", nameEn: "KANPEI", nameJa: "甘平", category: "FRUIT", season: "WINTER", iconKey: "citrus_orange", sortOrder: 13 },
  { id: "wi-f-14", nameEn: "BANPEIYU", nameJa: "晩白柚", category: "FRUIT", season: "WINTER", iconKey: "citrus_yellow", sortOrder: 14 },
  { id: "wi-f-15", nameEn: "SWEET SPRING", nameJa: "スイートスプリング", category: "FRUIT", season: "WINTER", iconKey: "citrus_yellow", sortOrder: 15 },
  { id: "wi-f-16", nameEn: "YUZU", nameJa: "柚子（ゆず）", category: "FRUIT", season: "WINTER", iconKey: "citrus_yellow", sortOrder: 16 },

  // --- Vegetables ---
  { id: "wi-v-1", nameEn: "WINTER DAIKON", nameJa: "大根", category: "VEGETABLE", season: "WINTER", iconKey: "root_vegetable", sortOrder: 20 },
  { id: "wi-v-2", nameEn: "CHINESE CABBAGE", nameJa: "白菜", category: "VEGETABLE", season: "WINTER", iconKey: "leafy_green", sortOrder: 21 },
  { id: "wi-v-3", nameEn: "LONG ONION", nameJa: "長ねぎ", category: "VEGETABLE", season: "WINTER", iconKey: "onion", sortOrder: 22 },
  { id: "wi-v-4", nameEn: "SPINACH", nameJa: "ほうれん草・ちぢみ", category: "VEGETABLE", season: "WINTER", iconKey: "leafy_green", sortOrder: 23 },
  { id: "wi-v-5", nameEn: "KOMATSUNA", nameJa: "小松菜", category: "VEGETABLE", season: "WINTER", iconKey: "leafy_green", sortOrder: 24 },
  { id: "wi-v-6", nameEn: "CROWNDAIZY", nameJa: "春菊", category: "VEGETABLE", season: "WINTER", iconKey: "leafy_green", sortOrder: 25 },
  { id: "wi-v-7", nameEn: "MIZUNA", nameJa: "水菜", category: "VEGETABLE", season: "WINTER", iconKey: "leafy_green", sortOrder: 26 },
  { id: "wi-v-8", nameEn: "TURNIP", nameJa: "かぶ・聖護院かぶ", category: "VEGETABLE", season: "WINTER", iconKey: "root_vegetable", sortOrder: 27 },
  { id: "wi-v-9", nameEn: "SHOGOIN DAIKON", nameJa: "聖護院大根", category: "VEGETABLE", season: "WINTER", iconKey: "root_vegetable", sortOrder: 28 },
  { id: "wi-v-10", nameEn: "KINTOKI CARROT", nameJa: "金時人参", category: "VEGETABLE", season: "WINTER", iconKey: "root_vegetable", sortOrder: 29 },
  { id: "wi-v-11", nameEn: "SHIMONITA LEEK", nameJa: "下仁田ねぎ", category: "VEGETABLE", season: "WINTER", iconKey: "onion", sortOrder: 30 },
  { id: "wi-v-12", nameEn: "KUJO LEEK", nameJa: "九条ねぎ", category: "VEGETABLE", season: "WINTER", iconKey: "onion", sortOrder: 31 },
  { id: "wi-v-13", nameEn: "LILY BULB", nameJa: "百合根", category: "VEGETABLE", season: "WINTER", iconKey: "root_vegetable", sortOrder: 32 },
  { id: "wi-v-14", nameEn: "BRUSSELS SPROUTS", nameJa: "芽キャベツ", category: "VEGETABLE", season: "WINTER", iconKey: "cabbage", sortOrder: 33 },

  // --- Seafood ---
  { id: "wi-s-1", nameEn: "WINTER YELLOWTAIL", nameJa: "寒ブリ", category: "SEAFOOD", season: "WINTER", iconKey: "fish_yellow", sortOrder: 40 },
  { id: "wi-s-2", nameEn: "WINTER MACKEREL", nameJa: "寒鯖", category: "SEAFOOD", season: "WINTER", iconKey: "fish_blue", sortOrder: 41 },
  { id: "wi-s-3", nameEn: "WINTER FLOUNDER", nameJa: "ヒラメ・寒平目", category: "SEAFOOD", season: "WINTER", iconKey: "fish_silver", sortOrder: 42 },
  { id: "wi-s-4", nameEn: "PUFFERFISH", nameJa: "河豚（ふぐ）", category: "SEAFOOD", season: "WINTER", iconKey: "pufferfish", sortOrder: 43 },
  { id: "wi-s-5", nameEn: "MONKFISH", nameJa: "あんこう", category: "SEAFOOD", season: "WINTER", iconKey: "fish_blue", sortOrder: 44 },
  { id: "wi-s-6", nameEn: "SHIRACO", nameJa: "白子", category: "SEAFOOD", season: "WINTER", iconKey: "shellfish", sortOrder: 45 },
  { id: "wi-s-7", nameEn: "OYSTER", nameJa: "牡蠣（真牡蠣）", category: "SEAFOOD", season: "WINTER", iconKey: "oyster", sortOrder: 46 },
  { id: "wi-s-8", nameEn: "PACIFIC COD", nameJa: "たら", category: "SEAFOOD", season: "WINTER", iconKey: "fish_silver", sortOrder: 47 },
  { id: "wi-s-9", nameEn: "TARAKO", nameJa: "たらこ", category: "SEAFOOD", season: "WINTER", iconKey: "salmon_roe", sortOrder: 48 },
  { id: "wi-s-10", nameEn: "SEA CUCUMBER", nameJa: "なまこ", category: "SEAFOOD", season: "WINTER", iconKey: "shellfish", sortOrder: 49 },
  { id: "wi-s-11", nameEn: "KUE GROUPER", nameJa: "くえ", category: "SEAFOOD", season: "WINTER", iconKey: "fish_silver", sortOrder: 50 },
  { id: "wi-s-12", nameEn: "SNOW CRAB", nameJa: "ズワイガニ", category: "SEAFOOD", season: "WINTER", iconKey: "crab", sortOrder: 51 },
  { id: "wi-s-13", nameEn: "KING CRAB", nameJa: "タラバガニ", category: "SEAFOOD", season: "WINTER", iconKey: "crab", sortOrder: 52 },
  { id: "wi-s-14", nameEn: "WINTER HORSEHAIR", nameJa: "毛ガニ", category: "SEAFOOD", season: "WINTER", iconKey: "crab", sortOrder: 53 },
];
